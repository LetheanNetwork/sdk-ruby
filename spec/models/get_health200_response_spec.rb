...
# Unit tests for LthnApi::GetHealth200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LthnApi::GetHealth200Response do
  #let(:instance) { LthnApi::GetHealth200Response.new }

  describe 'test an instance of GetHealth200Response' do
    it 'should create an instance of GetHealth200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LthnApi::GetHealth200Response)
    end
  end
